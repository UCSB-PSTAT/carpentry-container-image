                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"ggwordcloud\")"'
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"leaflet\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"lwgeom\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"osmdata\")"'
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"ratdat\")"'
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"sentimentr\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"sf\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"stringr\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"syuzhet\")"'
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tidytext\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tidyverse\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"units\")"'
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"wordcloud2\")"'
