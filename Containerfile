...
RUN R -e "install.packages(c('Orcs', 'BayesFactor', 'emoji', 'gapminder', 'ggwordcloud', 'Orcs', 'plyr', 'pscl', 'sentimentr', 'stringr', 'syuzhet', 'tidyterra', 'terra', 'tidyverse', 'wordcloud2'), repos = 'https://cloud.r-project.org/', Ncpus = parallel::detectCores())"
